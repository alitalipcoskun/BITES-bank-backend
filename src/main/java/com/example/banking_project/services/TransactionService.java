...
public class TransactionService {
    ...
    private final AccountWebSocketHandler webSocketHandler;

    @Transactional
    public TransactionDTO makeTransaction(@Valid @RequestBody TransferMoneyReq request) throws Exception {
        ...
        // Add received_account balance to the received_account balance
        fromAcc.setBalance(fromAcc.getBalance() - transactionAmount);
        // Save to the repo
        accountRepository.save(fromAcc);
        // Subtract the from_account balance to the amount
        ...
        webSocketHandler.notifyAccountChange("refresh");
